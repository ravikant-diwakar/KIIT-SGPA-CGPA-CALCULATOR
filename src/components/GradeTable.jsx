...
//             <th className="px-2 py-3 sm:px-4 sm:py-3 md:px-6 md:py-3 text-xs sm:text-sm md:text-base">
//               Grade
//             </th>
//             <th className="px-2 py-3 sm:px-4 sm:py-3 md:px-6 md:py-3 text-xs sm:text-sm md:text-base">
//               Score
...
//               }
//             >
//               <td className="px-2 py-3 sm:px-4 sm:py-3 md:px-6 md:py-4 text-center font-semibold text-xs sm:text-sm md:text-base">
//                 {item.grade}
//               </td>
//               <td className="px-2 py-3 sm:px-4 sm:py-3 md:px-6 md:py-4 text-center text-xs sm:text-sm md:text-base">
//                 {item.score}
//               </td>
//               <td className="px-2 py-3 sm:px-4 sm:py-3 md:px-6 md:py-4 text-center text-xs sm:text-sm md:text-base">
//                 {item.points}
